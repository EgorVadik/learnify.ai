...
export const NotificationAPIButton = memo(({ userId }: { userId: string }) => {
    ...
    return (
        <div
            id='CONTAINER_DIV_ID'
            className='[&_.notificationapi-notification-imageContainer]:hidden [&_.notificationapi-popup]:w-full [&_.notificationapi-popup]:min-w-80 [&_.notificationapi-popup]:max-w-xs'
        ></div>
    )
})
