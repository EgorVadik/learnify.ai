...
const variants = {
    base: 'relative rounded-md w-96 max-w-[calc(100vw-1rem)] flex justify-center items-center flex-col cursor-pointer border-2 border-dashed border-turq-600 dark:border-gray-300 transition-colors duration-200 ease-in-out bg-turq-muted',
    active: 'border-2',
    disabled:
                ...
                <div className='flex flex-col gap-2'>
                    <div>
                        ...
                        >
                            ...
                            <div className='flex items-center text-sm text-turq-600'>
                                <div className='border-r border-turq-600 px-2 py-1'>
