            ...
            <div>
                ...
                >
                    ...
                    {imageUrl && !disabled && (
                        ...
                        >
                            <div className='border-gray-500 dark:border-gray-400 flex h-5 w-5 items-center justify-center rounded-md border border-solid bg-white transition-all duration-300 hover:h-6 hover:w-6 dark:bg-black'>
                                <X
    ...
    return (
        <button
            className={twMerge(
                ...
                // color
                'border-gray-400 text-gray-400 shadow hover:text-gray-500 dark:border-gray-600 dark:hover:bg-gray-700 border hover:bg-gray-100 dark:text-gray-100',
                // size
